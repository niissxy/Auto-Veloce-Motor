...
import { Shield, Globe, Menu, X, Flame, LogOut, Key, Sun, Moon } from 'lucide-react';
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          {/* Desktop Nav Items */}
          <div className="hidden lg:flex items-center lg:gap-1 xl:gap-2">
            {navItems.map((item) => {
              ...
              return (
                <button
                  ...
                  className={`px-3 xl:px-4 py-2 text-[13px] font-semibold tracking-wide rounded-lg transition-all duration-200 ${
                    isActive
                      ? theme === 'dark'
          ...
          <div className="hidden lg:flex items-center gap-3">
            ...
            {!currentUser ? (
              <button
                ...
                className={`flex items-center gap-2 px-4 py-2.5 text-xs font-extrabold uppercase tracking-widest border rounded-xl transition-all active:scale-95 ${
                  theme === 'dark'
                    ? 'text-neutral-400 hover:text-white bg-neutral-900 hover:bg-neutral-850 border-neutral-800'
              ...
              <div className="flex items-center gap-3">
                ...
                {/* Active Admin Dashboard Tab Link */}
                <button
                  id="admin-dashboard-btn"
                  onClick={handleAdminClick}
                  className={`flex items-center gap-2 px-3 py-1.5 text-xs font-bold tracking-wide rounded-xl border transition-all ${
                    activeTab === 'admin'
                      ? 'text-white bg-red-600 border-red-500 shadow-lg shadow-red-600/20'
                      : theme === 'dark'
                        ? 'text-neutral-400 bg-neutral-900 border-neutral-800 hover:border-red-500/40 hover:text-white'
                        : 'text-slate-600 bg-white border-slate-200 hover:border-red-500/40 hover:text-slate-900 shadow-sm'
                  }`}
                >
        ...
        >
          ...
          <div className={`pt-4 border-t flex flex-col gap-3 ${
            ...
            {!currentUser ? (
              <button
                onClick={handleAdminClick}
                className={`w-full py-3.5 flex items-center justify-center gap-2 font-extrabold text-xs uppercase tracking-widest rounded-xl transition-all border ${
                  theme === 'dark'
              ...
              <div className="flex flex-col gap-3">
                ...
                <button
                  onClick={handleAdminClick}
                  className={`w-full py-3 flex items-center justify-center gap-2 rounded-xl font-bold text-sm border transition-all ${
                    activeTab === 'admin'
